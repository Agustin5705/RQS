...
export default function BasicPage() {
  ...
  const rangedModifier = calculateRangedModifier(int, dex);
    ...
    <main className="sheet">
      ...
      <section className="derived">
        ...
        <div className="derived-combat">
          ...
          <p>Melee Modifier: {damageModifier}</p>
          <p>Ranged Modifier: {rangedModifier}</p>
        </div>
            ...
            <div key={index}>
              ...
              {weapon && (
                <div className="weapon-details">
                  ...
                  <button
                    onClick={() => {
                      const modifier = weapon.ranged
                        ? rangedModifier
                        : weapon.magical
                          ? magicModifier
                          : damageModifier;

                      const damage = rollWeaponDamage(weapon.damage, modifier);
